    ...
    return (
        <>
            <Link to={`/pet/${props.id}`}>
                <div id={props.id} className={`card w-[200px] h-[300px] bg-[#D9D9D9] flex justify-center items-center flex-col rounded-[70px] border-[10px] border-solid border-[#c7c4c450] relative shadow-[10px_10px_0px_#a3a1a15d] ${props.space} my-[10px] mx-[20px] cursor-pointer`}>
