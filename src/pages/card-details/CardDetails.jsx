                ...
                <div className="w-full flex flex-col bg-left bg-contain bg-no-repeat" style={{ backgroundImage: `url(${bg_card_3})` }} >
                    <div className="w-10/12 m-auto my-12 ">
                        ...
                        <div className="flex justify-evenly flex-wrap">
                            <Link to="/" className="rounded-full bg-primary h-fit py-2 px-10 text-2xl text-white mb-2">
                                adapt me
                            </Link>
                            <Link to="/" className="rounded-full bg-lightYellow h-fit py-2 px-10 text-2xl text-white mb-2">
                                message
                            </Link>
                        </div>
                    </div>
