...
const SectionsHome = () => {
    ...
    return (
        <>
            ...
            <section className="w-full flex justify-end max-lg:justify-center max-lg:my-10">
                <img src={image_16} alt="" className="translate-y-[-30px] translate-x-[120px] max-lg:hidden" />
                <div className="bg-container w-10/12 max-lg:w-full h-fit flex max-lg:flex-col justify-center items-center bg-contain bg-center bg-no-repeat" style={{backgroundImage: `url(${bg_image_3})`}}>
                    <div className=" flex">
                    ...
                    >
                        <div ref={scrollRef}>
                            <ul className="flex justify-center items-center w-full max-lg:flex-wrap ">
